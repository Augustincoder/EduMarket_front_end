...
function SettingItem({ title, desc, checked, onChange }) {
  return (
    <div className="flex items-center justify-between p-4 bg-edu-surface border border-edu-border/50 rounded-xl active:scale-[0.97] transition-transform duration-[120ms] shadow-sm">
