...
import { Search, Ban, Crown, ShieldAlert, GraduationCap, Check, X, Shield, Eye } from 'lucide-react';
...
export default function AdminUsers() {
  ...
  return (
    <div className="space-y-6 animate-fade-in text-slate-100">
      ...
      {/* ── Filter Bar ────────────────────────────────────── */}
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 bg-slate-950/40 border border-slate-800/60 p-5 rounded-3xl">
        <div className="relative md:col-span-2">
          ...
          <input
            type="text"
            placeholder="Foydalanuvchi ismi yoki username qidirish..."
            value={search}
